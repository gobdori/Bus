...
public class BusTimesTableModel  extends AbstractTableModel 
{
	...
	public BusTimesTableModel(Vector<BusColumn> buslist) 
	{
	...
	public BusTimesTableModel(Vector<BusColumn> buslist, Vector<String> columnNames) 
	{		
		setBusTimesTableModel(buslist, columnNames);
	}
	
	public BusTimesTableModel(Vector<BusColumn> buslist, String[] columnNames) {
		
		setBusTimesTableModel(
				buslist, getColumnsArrayToVecotr(columnNames));
	}
	
	public void setBusTimesTableModel(
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		/*
		case 0 :
			return buscol.getBUSTIMEID();
			
		case 1 :
			return buscol.getBUSTYPEID();
			
		case 2 :
			return buscol.getDESTMNID();
			
		case 3 :
			return buscol.getARRTMNID();
			
		case 4 :			
			return buscol.getBUSSTTIME();
			
		case 5 :
			return buscol.getBUSPRICE();
			
		case 6 :
			return buscol.getBUSLEADTIME();
			*/
		default :
			return null;			
		}
